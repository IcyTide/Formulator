...
ATTR_TYPE_TRANSLATE = {
    ...
    "lunar_attack_power_base": "阴性内功攻击",
    "solar_attack_power_base": "阳性内功攻击",
    "neutral_attack_power_base": "混元内功攻击",
    "solar_and_lunar_attack_power_base": "阴阳内功攻击",
    "poison_attack_power_base": "毒性内功攻击",
    "physical_critical_strike_base": "外功会心",
    "magical_critical_strike_base": "内功会心",
    "lunar_critical_strike_base": "阴性内功会心",
    "solar_critical_strike_base": "阳性内功会心",
    "neutral_critical_strike_base": "混元内功会心",
    "solar_and_lunar_critical_strike_base": "阴阳内功会心",
    "poison_critical_strike_base": "毒性内功会心",
    "all_critical_strike_base": "全会心",
    "physical_critical_power_base": "外功会心效果",
    "magical_critical_power_base": "内功会心效果",
    "lunar_critical_power_base": "阴性内功会心效果",
    "solar_critical_power_base": "阳性内功会心效果",
    "neutral_critical_power_base": "混元内功会心效果",
    "solar_and_lunar_critical_power_base": "阴阳内功会心效果",
    "poison_critical_power_base": "毒性内功会心效果",
    "all_critical_power_base": "全会心效果",
    "physical_overcome_base": "外功破防",
    "magical_overcome_base": "内功破防",
    "lunar_overcome_base": "阴性内功破防",
    "solar_overcome_base": "阳性内功破防",
    "neutral_overcome_base": "混元内功破防",
    "solar_and_lunar_overcome_base": "阴阳内功破防",
    "poison_overcome_base": "毒性内功破防",
    "surplus_base": "破招",
    "strain_base": "无双",
    "haste_base": "加速",
}
