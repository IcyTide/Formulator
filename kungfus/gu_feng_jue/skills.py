...
SKILLS: Dict[int, Dict[type, Dict[int, dict]]] = {
    0: {
        Skill: {
            ...
            **{skill_id: dict(bind_dot=24132, bind_stack=i + 1) for i, skill_id in
               enumerate(range(32372, 32369 - 1, -1))},
            **{skill_id: dict(bind_dot=24443, bind_stack=i + 1) for i, skill_id in
               enumerate(range(32874, 32869 - 1, -1))}
        }
    },
    1: {
        Skill: {
