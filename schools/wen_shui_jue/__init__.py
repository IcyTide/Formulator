...
from schools.wen_shui_jue.recipes import RECIPE_CHOICES, RECIPES
from schools.wen_shui_jue.skills import SKILLS
from schools.wen_shui_jue.talents import TALENT_CHOICES, TALENTS, TALENT_DECODER, TALENT_ENCODER
